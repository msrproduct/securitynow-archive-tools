...
# --------- Helper: year from episode ---------

function Get-YearFromEpisode {
param([int]$Episode)
    if ($Episode -le 60)   { return 2005 }
    if ($Episode -le 112)  { return 2006 }
    if ($Episode -le 164)  { return 2007 }
    if ($Episode -le 216)  { return 2008 }
    if ($Episode -le 268)  { return 2009 }
    if ($Episode -le 320)  { return 2010 }
    if ($Episode -le 372)  { return 2011 }
    if ($Episode -le 424)  { return 2012 }
    if ($Episode -le 476)  { return 2013 }
    if ($Episode -le 528)  { return 2014 }
    if ($Episode -le 580)  { return 2015 }
    if ($Episode -le 632)  { return 2016 }
    if ($Episode -le 684)  { return 2017 }
    if ($Episode -le 736)  { return 2018 }
    if ($Episode -le 788)  { return 2019 }
    if ($Episode -le 840)  { return 2020 }
    if ($Episode -le 892)  { return 2021 }
    if ($Episode -le 944)  { return 2022 }
    if ($Episode -le 996)  { return 2023 }
    if ($Episode -le 1048) { return 2024 }
    if ($Episode -le 1100) { return 2025 }
    return 2025
}
...
# ============================================
# STEP 2: Download GRC notes PDFs / index
# ============================================
...
$episodesWithAnyNotes = ($index | Where-Object {
    ($_.File -like "sn-*-notes.pdf" -or $_.File -like "sn-*-notes-ai.pdf") -and
    ([int]$_.Episode -ge $MinEpisode)
}).Episode | Sort-Object -Unique
...
# ============================================
# STEP 4: AI notes for missing episodes
# ============================================
...
if (Test-Path -LiteralPath $IndexCsv) {
    Import-Csv -Path $IndexCsv | Sort-Object Episode | Select-Object -First 20 | Format-Table
} else {
